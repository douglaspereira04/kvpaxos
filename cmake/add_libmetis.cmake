...
ExternalProject_Add(project_libmetis
    SOURCE_DIR
        "${CMAKE_SOURCE_DIR}/external/METIS"
    CONFIGURE_COMMAND
        cd ${CMAKE_SOURCE_DIR}/external/METIS && make config prefix=${LIBMETIS_PREFIX}
    BUILD_COMMAND
        ""
    INSTALL_COMMAND
        cd ${CMAKE_SOURCE_DIR}/external/METIS && make -C build install
)
